          ...
          <SiteContent>
            ...
            <div>
              <FooterList>
                ...
                <FooterList.FooterItem>Chicago</FooterList.FooterItem>
                <FooterList.FooterItem>Los Angeles</FooterList.FooterItem>
                <FooterList.FooterItem>Miami</FooterList.FooterItem>
                <FooterList.FooterItem>New York</FooterList.FooterItem>
              </FooterList>
            </div>
            <div className="site-footer-category-wrapper">
              <FooterList>
                <FooterList.FooterItem>
                  <FooterList.FooterHeading>
                    Lists by Category
                  </FooterList.FooterHeading>
                </FooterList.FooterItem>
                <FooterList.FooterItem>Apartments</FooterList.FooterItem>
                <FooterList.FooterItem>Condos</FooterList.FooterItem>
                <FooterList.FooterItem>Houses</FooterList.FooterItem>
                <FooterList.FooterItem>Offices</FooterList.FooterItem>
                <FooterList.FooterItem>Retail</FooterList.FooterItem>
                <FooterList.FooterItem>Retail</FooterList.FooterItem>
              </FooterList>
            </div>
            <div className="site-footer-wrapper">
              <FooterList>
                ...
                <FooterList.FooterItem>About Us</FooterList.FooterItem>
                <FooterList.FooterItem>
                  LTerms & Conditions
                </FooterList.FooterItem>
                <FooterList.FooterItem>Support Center</FooterList.FooterItem>
                <FooterList.FooterItem>Contact Us</FooterList.FooterItem>
              </FooterList>
            </div>
          </SiteContent>
        </FooterMain>
